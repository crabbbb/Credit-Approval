...
def main() :
    ...
    ## A2 
    numberA2 = st.number_input("Enter value for A2 > ", min_value=0.0, format="%.4f")
    ...
    ## A3
    numberA3 = st.number_input("Enter value for A3 > ", min_value=0.0, format="%.4f")
    ...
    ## A8
    numberA8 = st.number_input("Enter value for A8 > ", min_value=0.0, format="%.4f")
    ...
    ## A14
    numberA14 = st.number_input("Enter value for A14 > ", min_value=0.0, format="%.4f")
    ...
    ## A15
    numberA15 = st.number_input("Enter value for A15 > ", min_value=0.0, format="%.4f")
